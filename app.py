...
from utils.demo_data import demo_sequence, generate_timeline_data
...
if page == "Dashboard":
    ...
    st.button("View Detailed Analysis", on_click=lambda: st.session_state.update({"page": "Admin Console"}))
